...
async def scrape():
    ...
    async with async_playwright() as p:
        ...
        await page.goto('https://fanvue.com/sign-in', wait_until='domcontentloaded')
        await page.wait_for_timeout(3000)

        await page.fill('input[type="email"]', FANVUE_EMAIL)
        await page.wait_for_timeout(400)
        await page.fill('input[type="password"]', FANVUE_PASSWORD)
        await page.wait_for_timeout(400)
